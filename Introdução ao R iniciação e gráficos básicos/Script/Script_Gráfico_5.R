##############################################################################
##############Fazendo Gráfico de Barras Horizontal de Proporção (%)###########
#############################################################################
...
tabela1<-round(prop.table(tabela)*100,2)    #montando uma tabela com a variável escolaridade
tabela1                           #mostrando a tabulação dos dados


par(bg="white")                     #inserindo uma cor de fundo do gráfico
...
#ylab="% Escolaridade",          #nomeia o eixo y  -> a inclusão será manual
xlab="Nº de pessoas",                        #nomeia o eixo x
main="Escolaridade \n dos Entrevistados",    #título do gráfico
xlim=c(0,63),                             #origem do eixo-x em 0 e fim em 23
...
mtext(side = 2, text = "% Escolaridade",    #inserção manual do nome do eixo-y
